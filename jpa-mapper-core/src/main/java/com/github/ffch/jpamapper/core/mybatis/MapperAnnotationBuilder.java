package com.github.ffch.jpamapper.core.mybatis;
...
public class MapperAnnotationBuilder {
	...
	protected Set<Class<? extends Annotation>> sqlAnnotationTypes = new HashSet<Class<? extends Annotation>>();
	protected Set<Class<? extends Annotation>> sqlProviderAnnotationTypes = new HashSet<Class<? extends Annotation>>();
	...
	public void parsePendingMethods() {
	...
	public Properties convertToProperties(Property[] properties) {
	...
	public String parseResultMap(Method method) {
	...
	public String generateResultMapName(Method method) {
		Results results = method.getAnnotation(Results.class);
	...
	public void applyResultMap(String resultMapId, Class<?> returnType, Arg[] args, Result[] results,
	...
	public void createDiscriminatorResultMaps(String resultMapId, Class<?> resultType,
			TypeDiscriminator discriminator) {
	...
	public Discriminator applyDiscriminator(String resultMapId, Class<?> resultType, TypeDiscriminator discriminator) {
		if (discriminator != null) {
	...
	public LanguageDriver getLanguageDriver(Method method) {
	...
	public SqlSource buildSqlSourceFromStrings(String[] strings, Class<?> parameterTypeClass,
	...
	public Class<? extends Annotation> chooseAnnotationType(Method method, Set<Class<? extends Annotation>> types) {
	...
	public void applyResults(Result[] results, Class<?> resultType, List<ResultMapping> resultMappings) {
	...
	public String nestedSelectId(Result result) {
	...
	public boolean isLazy(Result result) {
	...
	public boolean hasNestedSelect(Result result) {
	...
	public void applyConstructorArgs(Arg[] args, Class<?> resultType, List<ResultMapping> resultMappings) {
		for (Arg arg : args) {
			List<ResultFlag> flags = new ArrayList<ResultFlag>();
	...
	public Result[] resultsIf(Results results) {
		return results == null ? new Result[0] : results.value();
	}

	public Arg[] argsIf(ConstructorArgs args) {
